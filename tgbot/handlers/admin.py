...
async def admin_start(message: Message, state: FSMContext):
    ...
    await add_entry(Session, operation_id=3, dr="20", cr="10.1", amount=Decimal(900.00))
    await add_entry(Session, operation_id=5, dr="43", cr="20", amount=Decimal(900.00))
    await add_entry(Session, operation_id=5, dr="90.2", cr="43", amount=Decimal(900.00))
    await add_entry(Session, operation_id=6, dr="62", cr="90.1", amount=Decimal(1200.00))
    await add_entry(Session, operation_id=7, dr="51", cr="62", amount=Decimal(1200.00))
