...
def shift_menu_dialogs(tz: str = "UTC", calendar_locale=(None, None)):
    return [
        Dialog(
            ...
            windows.set_shift_duration_window(),
            windows.multi_select_from_dct_window(),
            windows.select_from_dct_window(),
            windows.set_activity_comment(),
            windows.set_material_quantity(),
            windows.set_product_bag_quantity(),
